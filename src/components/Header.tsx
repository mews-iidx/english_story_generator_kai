...
import { BookOpen, Bookmark, History, Settings, Cloud, RefreshCw } from 'lucide-react';

export type NavTab = 'reader' | 'vocab' | 'history' | 'settings';
        ...
        >
          ...
          <div>
            <span className="text-lg font-bold tracking-tight text-white flex items-center gap-1.5">
              StoryKai <span className="text-xs px-1.5 py-0.5 rounded-md bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 font-medium">A1-C1 / SRS</span>
            </span>
          </div>
        </div>
